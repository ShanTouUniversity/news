...
### 可以发布的类型
- OA 通知 / 公告（含人事任命、奖项公示、活动通知、培训招募等）
- 公众号推文
- 其他公开来源信息
- **校内内部消息**：如人事任命、组织架构调整、评奖评优结果公示等，可作为校园新闻发布
- **行政通知**：教学质量工程项目验收、考试封楼、停水停电、设施维修等后勤保障类通知均可包装成新闻发布

### 不宜发布的类型
- 纯党务内部文件（如党内走访慰问、党员先锋公示、党支部活动等不对外公开的内容）
- 涉及敏感信息的文件

### 注意事项
- 人事任命等校内任免信息可以发布，使用被任命人全名（教职员工适用）
- 公示类通知可以发布，但需对学生姓名进行匿名化处理
